            ...
            <div className="w-full md:w-3/4 ">
              ...
              <div className="px-3 md:px-4">
                <p className="text-lg font-light text-black md:text-xl 2xl:text-xl lg:text-2xl">
                  ...
                  opinion concerning what the exact nature of mind is and
                  various competing definitions have been proposed.
                  Philosophical definitions of mind usually proceed not just by
                  listing various types of phenomena belonging to the mind but
                  by searching the 'mark of the mental': a feature that is
                  shared by all mental states and only by mental states.
                  Epistemic approaches define mental states in terms of the
                  privileged epistemic access the subject has to these states.
                  This is often combined with a consciousness-based approach,
                  which emphasizes the primacy of consciousness in relation to
                  mind.
                </p>
              </div>
            </div>
      ...
      <div className="flex flex-col items-center justify-center bg-slate-200 min-h-[30rem] md:min-h-[25rem] lg:min-h-[30rem] ">
        <div className="my-10 text-center lg:w-3/5 lg:my-16">
          ...
          <p className="px-5 text-base md:px-10 lg:text-xl lg:px-0">
            Despite this agreement, there is still a lot of difference of
            opinion concerning what the exact nature of mind is and various
            competing definitions have been proposed.
          </p>
        </div>
        <div>
          <button className="px-4 py-1 text-white transition duration-150 bg-red-400 rounded-md lg:px-4 lg:py-2 lg:font-bold hover:bg-red-500">
            Browse jobs
          </button>
        </div>
      </div>
