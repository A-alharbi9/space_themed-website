    ...
    <section className="relative">
      <div className="absolute z-10 top-24 lg:top-52 left-28 lg:left-56">
        ...
        <div className="flex py-2 ml-2">
          <button className="px-3 py-2 text-lg text-center text-white transition duration-500 bg-orange-600 rounded-lg cursor-pointer hover:bg-orange-600 hover:text-black">
            Learn more
          </button>
        </div>
      </div>
